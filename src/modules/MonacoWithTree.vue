<template>
    <div ref="wrapper" :class="`monaco-with-tree${isFullScreen ? ' full-screen' : ''}`">
        <split-pane v-if="defaultSplitPercent" @resize="resize" :min-percent="minSplitPercent"
            :default-percent="defaultSplitPercent" split="vertical" class="monaco-with-tree-splitter">
            <template slot="paneL">
            ...
            <template slot="paneR">
                <div class="monaco-right-pane">
                    ...
                    <div ref="monaco"
                        :style="{ height: `calc(100% - ${tabHeight}px)`, visibility2: currentTab ? 'visible' : 'hidden' }" />
...
.monaco-with-tree .monaco-menu-pane {
    height: 100%;
}

.monaco-with-tree .monaco-right-pane {
    height: 100%;
    position: relative;
}

.monaco-with-tree .monaco-right-pane .vue-tabs-chrome {
    font-size: 14px;
}

.monaco-with-tree .monaco-right-pane .vue-tabs-chrome *,
.monaco-with-tree .monaco-right-pane .vue-tabs-chrome *::before,
.monaco-with-tree .monaco-right-pane .vue-tabs-chrome *::after {
    -webkit-box-sizing: border-box;
    box-sizing: border-box;
}

.monaco-with-tree .monaco-right-pane .vue-tabs-chrome .tabs-item.monaco-icon-label::before {
...
.monaco-with-tree .monaco-right-pane .no-tab-pane {
...
.monaco-with-tree .btn-fullscreen {
    position: absolute;
    top: 10px;
    right: 8px;
    z-index: 2000;
...
.monaco-with-tree .btn-fullscreen.fullscreen {
    position: fixed;
}

.monaco-with-tree .btn-fullscreen:hover {
    opacity: 1;
}
</style>